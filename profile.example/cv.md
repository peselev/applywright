...
@@@(size=12pt) [jordan.lin@example.com](mailto:jordan.lin@example.com) │ (555) 010-2837 │ [jordanlin.example](https://jordanlin.example?utm_source=cv&utm_medium=application&utm_campaign=BASE)

@@@(size=12pt) **Product Manager • B2B SaaS • Platform, AI, Growth**

## Education

**MBA** • **Ross School of Business, University of Michigan,** Ann Arbor, MI

**BS, Computer Science** • **University of Illinois Urbana-Champaign,** Urbana, IL
...
**Senior Product Manager** ||| 2019 – 2021
...
- First PM hire at an early-stage analytics startup; defined the initial roadmap, ran customer discovery across 30 design interviews, and shipped the MVP that secured the seed round.
