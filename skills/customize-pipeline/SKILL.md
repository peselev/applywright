...
- **Add or reshape a resume section.** An executive summary, a skills band, a publications or projects section — these are edits to `cv.md` (content) and, if the look needs adjusting, the template from Milestone 4.
